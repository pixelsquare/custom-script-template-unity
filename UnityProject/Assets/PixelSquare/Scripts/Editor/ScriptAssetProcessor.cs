...
namespace PixelSquare.Scripts.Editor
{
    ...
    public class ScriptAssetProcessor : UnityEditor.AssetModificationProcessor
    {
        ...
        public static void OnWillCreateAsset(string path)
        {
            ...
            string extension = filePath.Substring(extensionIdx);
        ...
        private static bool IsValidExtensionName(string filePath)
        {
        ...
        {
            string envVar = System.Environment.GetEnvironmentVariable(envVariableName);
